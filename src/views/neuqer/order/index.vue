<template>
  <div class="app-container orderHome">
    <el-form class="headerForm" :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch"
      ...
      <el-form-item prop="orderSn">
        <div class="queryInput">
          <el-select v-model="queryValue" placeholder="请选择" @change="handleQuery">
      ...
      <el-form-item label="配送方式:" prop="shippingMethod">
        <el-select v-model="queryParams.shippingMethod" placeholder="请选择配送方式"
                   clearable size="small" style="width: 140px" @change="handleQuery">
          <el-option
      ...
      <el-form-item label="地址:" prop="receiverDetailAddress">
        <el-input
    ...
    <div class="mid">
      <el-row type="flex" align="middle" class="midRow">
        <el-col :span="14">
          <el-tabs v-model="midTabsName" @tab-click="handleTabClick">
            ...
            <el-tab-pane label="售后中" name="3"></el-tab-pane>
            <el-tab-pane label="待付款" name="4"></el-tab-pane>
            <el-tab-pane label="交易关闭" name="5"></el-tab-pane>
          </el-tabs>
        </el-col>
        <el-col :span="10">
          <el-row>
            ...
            <el-table-column label="数量" width="200" align="center">
              <template slot-scope="scope">
                <div class="sigleNumber">
                  <span style="font-size: 13px">单次数量：{{scope.row.singleNumber}}</span>
              ...
              <template slot-scope="scope">
                <div class="tableLast">
                  ...
                  <el-button
                    ...
                    type="text"
                    icon="el-icon-edit"
                    @click="handleRemark(scope.row)">备注
                  </el-button>
                </div>
              </template>
            </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      this.queryValue = this.queryOptions[0].value
      this.getList()
    },
    methods: {
      /** 查询订单列表列表 */
      ...
      /** tabs标签点击事件 */
      handleTabClick() {
        if (this.midTabsName === 'first') {
          this.queryParams.orderStatus = undefined
        } else {
          this.queryParams.orderStatus = this.midTabsName
        }
        this.handleQuery()
      },
      /** 搜索按钮操作 */
      handleQuery() {
        if (this.queryInput !== '') {
          if (this.queryValue === '1') {
            this.queryParams.receiverPhone = this.queryInput
            this.queryParams.receiverName = undefined
            this.queryParams.productName = undefined
            this.queryParams.orderSn = undefined
          }
          if (this.queryValue === '2') {
            this.queryParams.receiverPhone = undefined
            this.queryParams.receiverName = this.queryInput
            this.queryParams.productName = undefined
            this.queryParams.orderSn = undefined
          }
          if (this.queryValue === '3') {
            this.queryParams.receiverPhone = undefined
            this.queryParams.receiverName = undefined
            this.queryParams.productName = this.queryInput
            this.queryParams.orderSn = undefined
          }
        ...
        if (this.queryParams.singleNumber === '' || this.queryParams.totalQuantity === '') {
          this.queryParams.singleNumber = undefined
          this.queryParams.totalQuantity = undefined
        }
